...
OpenLayers.Control.FeaturePopups = OpenLayers.Class(OpenLayers.Control, {
            ...
            if (feature.cluster) {
                ...
                if (feature.cluster.length == 1){
                    ...
                    this.popupObjs.hover.popup = this.showPopup(
                        ...
                        this.renderTemplate(template, OpenLayers.Util.extend(
     ...
     * Parameters:
     */
    showSelectPopup: function (popupObj, popupClass, popupId, lotLat, html, closeBox) {
        ...
        if (popupObj.html !== html) {
            this.destroyAllPopupObjs();
            popupObj.popup = this.showPopup(popupClass, popupId, lotLat, html, closeBox);
