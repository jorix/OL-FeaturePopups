...
OpenLayers.Control.FeaturePopups = OpenLayers.Class(OpenLayers.Control, {
    ...
    initialize: function(options) {
        ...
        var _closeBox = !!(this.mode & MODES.CLOSE_BOX),
            ...
            popupManager = OpenLayers.Control.FeaturePopups.Popup;
        var popupObjs = {};
        if (options.popupListOptions !== null) {
            popupObjs.list = new popupManager(
                this, 'list',
        ...
        if (options.popupSingleOptions !== null) {
            popupObjs.single = new popupManager(
                this, 'single',
        ...
        if (options.popupListItemOptions !== null) {
            popupObjs.listItem = new popupManager(
                this, 'listItem',
        ...
        if (options.popupHoverOptions !== null) {
            popupObjs.hover = new popupManager(
                this, 'hover',
        ...
        if (options.popupHoverListOptions !== null) {
            popupObjs.hoverList = new popupManager(
                this, 'hoverList',
    ...
    refreshLayers: function(useCursorLocation) {
        ...
        for (var layerId in this.layerObjs) {
            ...
            if (layerObj.active) {
                ...
                if (layerObj.popupObj && r.invalid) {
                    layerObj.popupObj.showPopup(
                        r.features,
                        r.bounds.getCenterLonLat(),
                        r.html,
                        r.staticInvalid
                    );
                } else {
...
OpenLayers.Control.FeaturePopups.Layer = OpenLayers.Class({
     ...
     *
     * Default options for internal use:
     * unselectFunction - Depends on the <FeaturePopups.mode>
     * closeBox - Depends on the <FeaturePopups.mode>
     * observeItems - true
     * relatedToClear - ["hover", "hoverList", "single", "listItem"]
     */
    popupOptions: null,
    ...
    initialize: function(control, layer, options) {
        ...
        if (options.popupOptions) {
            ...
            this.popupObj = new OpenLayers.Control.FeaturePopups.Popup(
                control, 'list',
                OpenLayers.Util.applyDefaults(options.popupOptions, {
                    popupClass: OpenLayers.Popup.FramedCloud,
                    panMapIfOutOfView: true,
                    // options for internal use
                    closeBox: _closeBox,
