...
OpenLayers.Control.FeaturePopups = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: refreshOnFeaturesremoved
     * {Boolean} Refresh popups when some features are removed. Default is true.
     */
    refreshOnFeaturesremoved: true,
    ...
    initialize: function (options) {
        ...
        this.layerListFeaturesTemplate = this.prepareTemplate(
    ...
    onFeaturesremoved: function (evt) {
        if (this.refreshOnFeaturesremoved) {
            this.showAllSelectedFeatures();
        }
    },
        ...
        for (i=0, len=layers.length; i<len; i++) {
            ...
            if (layerId == layer.id) {
                ...
                for (ii=0, len2 = features.length; ii<len2; ii++) {
                    ...
                    if (feature.id == featureId && !feature.cluster) {
    ...
    showPopup: function (popupObj, lotLat, html, closeMethod) {
        ...
        if (popupClass && html) {
            ...
            // popupClass as a OpenLayers.Popup class.
                ...
                popup.contentDisplayClass = popup.contentDiv;
