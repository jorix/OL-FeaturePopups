    ...
    refreshLayers: function(useCursorLocation) {
        ...
        if (invalid) {
            ...
            if (this.popupObjs.list && !response) {
                ...
                lonLat = (useCursorLocation && countSelected === 1) ?
                    this.getLocationFromSelPixel(
                                              this.controls.select, sFeature0) :
...
OpenLayers.Control.FeaturePopups.Popup = OpenLayers.Class({
     ...
     *      is an array of selection objects, "popupClass" popupClass
     *      that will be used to display the popup. Selection objects have three
