...
Patches included:
    pending to review by OL team:
        https://github.com/openlayers/openlayers/pull/507 Get right size when force height or width.
        https://github.com/openlayers/openlayers/pull/485 Get right scrollbar width.
        https://github.com/openlayers/openlayers/pull/533 Using IE no parent is a object!
        https://github.com/openlayers/openlayers/pull/544 Extra padding.
        https://github.com/openlayers/openlayers/pull/565 Fractional size using IE9.
        https://github.com/openlayers/openlayers/pull/566 Take into account scroll bar to calculate min/max size.
        https://github.com/openlayers/openlayers/pull/613 FramedCloud Popup: adjust the insertion point.
        https://github.com/openlayers/openlayers/pull/631 Avoid breaking the "OpenLayers.String.format" execution
    fixed in 2.12:
        https://github.com/openlayers/openlayers/pull/505
    other patches included but are pending publication as "Pull Rquest" on OL:
        * Chrome+ABP does not consider the size of images (https://github.com/openlayers/openlayers/issues/595).
        * Consider the border on `contentDisplayClass`.
        * Margin should be considered when padding on `contentDisplayClass` is zero.
*/
...
OpenLayers.Util.getRenderedDimensions = function(contentHTML, size, options) {
    ...
    var noMargin = '<div style="margin:0px; clear:both; padding:0; height:1px; width:1px; line-height:1px"></div>';
...
OpenLayers.Popup.prototype.getContentDivPadding = function() {
    ...
    if (!contentDivPadding) {
        ...
        contentDivPadding.left += contentDivBorder.left;
        contentDivPadding.bottom += contentDivBorder.bottom;
        contentDivPadding.right += contentDivBorder.right;
        contentDivPadding.top += contentDivBorder.top;
